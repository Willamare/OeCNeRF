...
class Config:
    ...
    llffhold: int = 100  # Use every Nth image for the test set. Used only by LLFF.
    ...
    max_steps: int = 10000  # The number of optimization steps.
    early_exit_steps: Optional[int] = None  # Early stopping, for debugging.
    checkpoint_every: int = 1000  # The number of steps to save a checkpoint.
